...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light ">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="#donate-now">Donate Now</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="ambulance-service.php">Ambulance Service</a>
						</li>
	...
	<section class="testimonial" id="donate-now">
		<div class="container">
			<div class="testimonial-heading">
				<h1 class="text-center">
					Donate Now
				</h1>
				<a href="create-donation.php">Request for Donation</a>
